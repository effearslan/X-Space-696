...
space_1 = Space.create!(travel_date: Date.today, destination: "Paris", height: 10, width:10, depth:10, price: 100, location: "Istanbul", name:"Space-1", user: user_1 )
space_2 = Space.create!(travel_date: Date.today + 1, destination: "New York", height: 20, width:20, depth:20, price: 200, location: "London", name:"Space-2", user: user_2 )
space_3 = Space.create!(travel_date: Date.today + 2, destination: "Beijing",height: 30, width:30, depth:30, price: 300, location: "Madagascar", name:"Space-3", user: user_3 )
